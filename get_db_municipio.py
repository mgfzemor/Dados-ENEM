...
import struct
db = 'data/2014/out/db_aluno.bin'
cod = 1
print 'reading file...'
alunos = unpack_data(aluno_struct,db,cod)
print 'ok!'
...
db_municipio = open('data/2014/out/municipio/db_municipio.bin','wb')
municipio_alunos = open('data/2014/out/municipio/municipio_alunos.bin','wb')
municipio_escolas = open('data/2014/out/municipio/municipio_escolas.bin','wb')
index_municipio = open('data/2014/out/municipio/index_municipio.bin','wb')
